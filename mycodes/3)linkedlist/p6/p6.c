// C program to detect loop in a linked list and if loop exists find starting node of a loop in a linked list
#include<stdio.h>
#include<stdlib.h>
...
struct node *loop_round = slow_p->next;



 while(first_data != loop_round->data)
 {

   loop_count++;

   loop_round = loop_round->next;
