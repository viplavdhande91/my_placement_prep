...
S1)TRAVERSE FROM TAIL OF ARRAY TO START AND FIND MAXIMUM ELEMENT (STORE IT IN var1)

S2)CAPTURE THE INDEX OF MAX ELEMENT

S3)RUN FROM START TO MAX_ELEMENT'S INDEX AND TRY TO FIND MINIMUM (STORE IT IN var2)

S4) CALACULATE DIFFRENCE OF var1- var2
*/