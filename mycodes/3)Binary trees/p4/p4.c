...
{ 
    /* 1. if both trees are NULL then it is Identical */
    if (a == NULL && b == NULL) 
        return 1; 
  
    /* 2. both pointers pointing to something */
   if (a && b) 
    { 
                                      //compare LST1 vs LST2
...
https://www.youtube.com/watch?v=kL5Gs1YTwMM&ab_channel=VivekanandKhyade-AlgorithmEveryDay
